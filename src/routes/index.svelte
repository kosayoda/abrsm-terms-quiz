...
<header class="flex justify-center align-middle bg-gray-800">
	<div class="flex flex-col mt-8 space-y-10">
		...
		<nav
			class="flex flex-col sm:flex-row justify-between align-middle w-full bg-gray-100 text-gray-500 sm:space-x-4"
		>
			<button
				class="{langString === 'all'
					? 'italic'
					: ''} font-bold hover:text-gray-700 hover:underline h-full w-full py-4"
	...
	<div class="flex justify-center mt-10">
		<div class="bg-white rounded-lg shadow-md max-w-2xl w-full h-56">
			<button
				...
				on:click={() => (reveal = true)}>Click to reveal</button
			>
